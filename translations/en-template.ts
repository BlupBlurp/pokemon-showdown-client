...
export const translations: TranslationCatalog = {
	...
	" ({PARENTHETICAL})": null,
	"Giratina is Relumi's mascot! It is a fierce and powerful Pokémon, and represents our battles.": null,
	...
	"Meloetta is PS's mascot! The Aria forme is about using its voice, and represents our chatrooms.": null, // NOT USED
	"Meloetta is PS's mascot! The Pirouette forme is Fighting-type, and represents our battles.": null, // NOT USED
	...
	"(Private room?)": null,
	"Search results": null,
	"Shaymin is Relumi's mascot! It loves nature and friendship, and represents our chatrooms.": null,
