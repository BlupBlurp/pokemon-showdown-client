...
global.Dex = {resourcePrefix: '', getPokemonIcon() { return ''; }, getItemIcon() { return ''; }, getLuminescentUrl() { return ''; }};
...
describe('PSSearchResults', () => {
	...
	it('renders everything outside the localized base species in small text', () => {
		const renderRow = (canonicalName, name, baseSpecies) => {
			...
			renderer._relumi = {
				getStatClass() { return ''; },
				getStatDiff() { return null; },
				isNewRelumiAbility() { return false; },
				cacheHas() { return false; },
				cacheGet() { return null; },
				cacheSet() {},
				shouldHighlightRelumiChanges() { return false; },
			};
